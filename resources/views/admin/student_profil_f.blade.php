        ...
        <div class="col-lg-4">
            ...
            <div class="iq-card">
                <div class="iq-card-header d-flex justify-content-between">
                    ...
                    <p style="text-align: right">
                        <button type="button" class="btn btn-link" style="font-size: 18px">
                            <i class="ri-pencil-line pr-0" style="color:rgb(240, 147, 224)" data-toggle="modal" data-target=".model5"></i>
                        </button>
                        <button type="button" class="btn btn-link"  style="font-size: 22px">
                            <i class="ri-add-line pr-0" style="color:rgb(240, 147, 224)" data-toggle="modal" data-target="#parentplus"></i>
                        </button>
                    </p>
                             ...
                             <div class="modal-body">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="parent">
                                            <option value="">-- choisir les parents --</option>
                                            @foreach ($parents1 as $par)
                                            <option value="{{$par->id}}">{{$par->pre.' '.$par->nom}}</option>
                                            @endforeach
                                        </select>
                                     ...
                                     <div class="form-group col-sm-6">
                                        ...
                                        <select class="form-control" name="trajet" id="trajet" >
                                            @if(empty($student->trajet))
                                                <option value="" selected="" disabled="">-- Trajet -- </option>
                                            @endif
            ...
            <div class="iq-card">
                <div class="iq-card-header d-flex justify-content-between">
                    ...
                    <button type="button" class="btn btn-link" style="font-size: 18px">
                        <i class="ri-pencil-line pr-0" style="color:rgb(240, 147, 224)" data-toggle="modal" data-target=".salam1"></i>
                    </button>
                </div>
                <div class="iq-card-body">
            ...
            <div class="iq-card">
                <div class="iq-card-header d-flex justify-content-between">
                    ...
                    <button type="button" class="btn btn-link" style="font-size: 18px">
                        <i class="ri-pencil-line pr-0" style="color:rgb(240, 147, 224)" data-toggle="modal" data-target=".salam3"></i>
                    </button>
                </div>
                <div class="iq-card-body">
                    <div class="about-info m-0 p-0">
                        ...
                        <div class="modal-content">
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="med_tel" value="{{$student->med_tel}}" id="med_tel" class="form-control">
                                    @error('med_tel')
                                        <span  style="color: red" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                ...
                <div class="col-md-6">
                    <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                            ...
                            <button type="button" class="btn btn-link" style="font-size: 18px">
                                <i class="ri-pencil-line pr-0" style="color:rgb(240, 147, 224)" data-toggle="modal" data-target=".model2"></i>
                            </button>
                        </div>
                        <div class="iq-card-body">
                            <div class="about-info m-0 p-0">
                ...
                <div class="col-md-6">
                    <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                            ...
                            <button type="button" class="btn btn-link" style="font-size: 18px">
                                <i class="ri-pencil-line pr-0" style="color:rgb(240, 147, 224)" data-toggle="modal" data-target=".model1"></i>
                            </button>
                        </div>
                        <div class="iq-card-body">
                            <div class="about-info m-0 p-0">
                                <div class="row">
                                    ...
                                    <div class="col-6 p-2">Adress :</div>
                                    <div class="col-6 p-2">{{$student->adress}}</div><br><br>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-sm-12"><a ><span> <h4>Frais 
                                            ...
                                            @if ($student->payement != 'anné')
                                                <button type="button" class="btn btn-link" style="font-size: 18px">
                                                    <i class="ri-pencil-line pr-0" style="color:rgb(240, 147, 224)" data-toggle="modal" data-target="#modeltest"></i>
                                                </button>
                                            @endif
                                            @if ($show == 'oui')
                                                <i class="ri-add-line" style="color:  rgb(240, 147, 224); font-size:23px" data-toggle="modal" data-target="#modeltest1"></i>
                                            @endif   
                                            </h4> </span> </a>
                        ...
                        <div class="iq-card iq-accordion-block">
                            <div class="active-faq clearfix">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <a  style="padding-right: 20px"><span><h4> Document <i class="ri-add-line" style="color:  rgb(240, 147, 224); font-size:23px" data-toggle="modal" data-target="#Document"></i></h4> </span> </a>
                                        </div>
                                                ...
                                                <tbody>
                                                        @foreach ($files as $file)
                                                            <tr>
                                                                ...
                                                                <td style="text-align: center"><a href="{{url('/admin/download/student_file/'.$file->id) }}"><button type="button" class="btn btn-link" style="font-size: 22px"><i class="ri-download-cloud-fill" style="color: rgba(240, 147, 224, 1)"></i></button></a></td>
                                                                <td  style="text-align: center">{{-- <button class="btn btn-danger" data-toggle="modal" data-target="#exampleModal{{$file->id}}">Supprimer</button> --}}
                                                                    <button type="button" class="btn btn-link" style="font-size: 18px">
                                                                        <i class="ri-delete-bin-2-fill" style="color: rgba(240, 147, 224, 1)" data-toggle="modal" data-target="#Document{{$file->id}}" ></i>
                                                                    </button>
                                                                </td>
                        ...
                        <div class="iq-card iq-accordion-block">
                            <div class="active-faq clearfix">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <a style="padding-right: 20px"><span > <h4> Timeline  <i class="ri-add-line" style="color:  rgb(240, 147, 224); font-size:23px" data-toggle="modal" data-target="#timeline"></i></h4> </span> </a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="d-inline-block w-100">
                                                            ...
                                                            @if (!empty($timeline1->image))
                                                                <a href="{{url('admin/download/timeline_file/'.$timeline1->id)}}"><b style="color:rgb(240, 147, 224)">Télécharger le document</b></a>
                                                            @endif
                                                        </div>
                                                    </li>
                                                @endforeach
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <div class="d-inline-block w-100">
                                                                        ...
                                                                        @if (!empty($timelines1->image))
                                                                            <a href="{{url('admin/download/timeline_file/'.$timelines1->id)}}"><b style="color:red">télécharger le document</b></a>
                                                                        @endif
                                                                    </div>
                                                                </li>
                                                                @endforeach
