        ...
        <div class="col-lg-4">
            <div class="iq-card">
                <div class="iq-card-body pl-0 pr-0 pt-0">
                    ...
                    <div class="doc-profile-bg bg-info" style="height:150px;text-align : right ">
                    </div>
                    ...
                    <h4><b>{{$student->nom.' '.$student->pre}}</b></h4>
                        ...
                        <h4><b style="color:rgba(2, 209, 255, 1)">{{$student->id1}}</b></h4>
                        ...
                        {{-- <p style="text-align: right">
                            <button type="button" class="btn btn-info mb-0" data-toggle="modal" data-target=".model4"><i class="ri-settings-4-fill pr-0"></i></button>
                        </p> --}}
                    </div>
                    </div>
                </div>
            </div>
            {{-- <a href="{{url('admin/Parent/'.$student->id)}}" class="btn  btn-info" > Ajouter </a><br><br> --}}
            <div class="iq-card">
                <div class="iq-card-header d-flex justify-content-between">
                    ...
                    {{-- <p style="text-align: right">
                        <button type="button" class="btn btn-info mb-0" data-toggle="modal" data-target=".model5"><i class="ri-settings-4-fill pr-0"></i></button>
                    </p> --}}
                ...
                <div class="iq-card-header d-flex justify-content-between">
                   <div class="iq-header-title">
                    ...
                    {{-- <button type="button" class="btn btn-link" style="font-size: 22px">
                        ...
                        <i class="ri-add-line" style="color: rgba(2, 209, 255, 1)" data-toggle="modal" data-target=".model6" ></i>
                    </button> --}}
            ...
            <div class="iq-card">
                <div class="iq-card-header d-flex justify-content-between">
                    ...
                    {{-- <button type="button" class="btn btn-link" style="font-size: 22px">
                        <i class="ri-add-line" style="color: rgba(2, 209, 255, 1)" data-toggle="modal" data-target=".model8" ></i>
                    </button> --}}
            ...
            {{-- <div class="col-md-6">
                <div class="iq-card">
                    <div class="iq-card-header d-flex justify-content-between">
                        ...
                        <button type="button" class="btn btn-info mb-0" data-toggle="modal" data-target=".model2"><i class="ri-settings-4-fill pr-0"></i></button>
                    </div>
                    <div class="iq-card-body">
            ...
            <div class="col-md-6">
                <div class="iq-card">
                    <div class="iq-card-header d-flex justify-content-between">
                        ...
                        <button type="button" class="btn btn-info mb-0" data-toggle="modal" data-target=".model1"><i class="ri-settings-4-fill pr-0"></i></button>
                    </div>
                    <div class="iq-card-body">
                        <div class="about-info m-0 p-0">
                            <div class="row">
            ...
            {{-- <div class="col-md-4">
                <div class="iq-card">
                    <div class="iq-card-header d-flex justify-content-between">
                        ...
                        <button type="button" class="btn btn-info mb-0" data-toggle="modal" data-target=".salam1"><i class="ri-settings-4-fill pr-0"></i></button>
                    </div>
                    <div class="iq-card-body">
                        <div class="about-info m-0 p-0">
                            <div class="row">
            ...
            <div class="col-md-4">
                <div class="iq-card">
                    <div class="iq-card-header d-flex justify-content-between">
                        ...
                        <button type="button" class="btn btn-info mb-0" data-toggle="modal" data-target=".salam2"><i class="ri-settings-4-fill pr-0"></i></button>
                    </div>
                    <div class="iq-card-body">
                        <div class="about-info m-0 p-0">
                            <div class="row">
            ...
            <div class="col-md-4">
                <div class="iq-card">
                    <div class="iq-card-header d-flex justify-content-between">
                        ...
                        <button type="button" class="btn btn-info mb-0" data-toggle="modal" data-target=".salam3"><i class="ri-settings-4-fill pr-0"></i></button>
                    </div>
                    <div class="iq-card-body">
                        <div class="about-info m-0 p-0">
                ...
                <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                   <div class="iq-card-header d-flex justify-content-between">
                      ...
                      <div class="iq-card-header-toolbar d-flex align-items-center">
                         <div class="dropdown">
                            <button type="button" class="btn btn-info mb-6" data-toggle="modal" data-target="#timeline">Ajouter</button>
                         </div>
                      </div>
                   </div>
                   <div class="iq-card-body">
                      ...
                      <button type="button" data-toggle="modal" data-target="#exampleModalScrollable" class="btn btn-link" style="font-size: 15px; float: right;">
                        <i class="ri-eye-line" style="color: rgba(2, 209, 255, 1)"> afficher tout</i>
                    </button>
                    </div>
                        <!-- Modal -->
                                    ...
                                    <ul class="iq-timeline">
                                        ...
                                        @foreach ($timelines as $timelines1)
                                          <li>
                                              ...
                                              ?>
                                              <div class="timeline-dots {{$number}}"></div>
                                              <h6 class="float-left mb-1"><b>{{$timelines1->by}}  ({{$timelines1->name}})</b> :</h6>
