          ...
          <ul class="navbar-list">
             <li>
                ...
                <img src="{{ url('assets/')}}/images/user/1.jpg" class="img-fluid rounded mr-3" alt="user">
                   <div class="caption">
                      <h6 class="mb-0 line-height">{{ Auth::guard('prof')->user()->nom.' '.Auth::guard('prof')->user()->pre}}</h6>
                      <span class="font-size-12">{{ Auth::guard('prof')->user()->fonction}}</span>
                   </div>
                </a>
                   ...
                   <div class="iq-card shadow-none m-0">
                      <div class="iq-card-body p-0 ">
                         <div class="bg-primary p-3">
                            <h5 class="mb-0 text-white line-height">{{ Auth::guard('prof')->user()->nom.' '.Auth::guard('prof')->user()->pre}}</h5>
